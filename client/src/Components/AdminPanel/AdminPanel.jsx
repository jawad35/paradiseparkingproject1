...
import AdminBlog from './AdminBlog/Blog/CreateBlogPost/CreateBlog';
        ...
        <div className='wrapper'>
          ...
          <div className='leftside-menu leftside-menu-detached'>
            ...
            <ul className='side-nav'>
              ...
              {/* <li className='side-nav-title side-nav-item'>Apps</li> */}
              <li className='side-nav-item'>
                <div onClick={AdminToggle} className='side-nav-link'>
                  <i className='uil-calender' />
                  <span> Blog </span>
                </div>
              </li>
              ...
              <li className='side-nav-item'>
                ...
                <div className='collapse' id='sidebarBlog'>
                  <ul className='side-nav-second-level'>
                    ...
                    <li>
                      <a href='apps-tasks-details.html'>Delete Blog</a>
                    </li>
                    <li>
                      <a href='apps-kanban.html'>Update Blog</a>
                    </li>
                     <li>
                      <a href='apps-kanban.html'>Search Blog</a>
                    </li>
                  </ul>
                </div>
              </li>
